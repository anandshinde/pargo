...
const baseCmsUrl = 'https://dev-cmsapi.mohawkind.com/site';
...
export const environment = {
	...
	autosuggestApi:
		'https://staging-suggest.dxpapi.com/api/v2/suggest/?account_id=6458&auth_key=7btuechtrabxo429&domain_key=mohawk_mohawkflooring_na',
	adobeDataLayerURL:
	...
	onDemand: {
		baseUrl:
			'https://api.cjjsup9vs1-mohawkcar1-d1-public.model-t.cc.commerce.ondemand.com',
